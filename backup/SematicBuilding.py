...
def main():
    xyxy_window= np.array([[49, 33, 178, 120],
                [361, 35, 430, 120],
                [590, 36, 720, 122],
                [47, 232, 178, 320],
                [361, 234, 428, 320],
    ...
    xyxy_glass=np.array([[62, 63, 111, 116],
                        [124, 63, 174, 116],
                        [369, 64, 419, 117],
                        [597, 66, 647, 118],
                        [658, 66, 708, 118],
    ...
    image_path = r"E:\Desktop\Simulationtest\Simulationtest\background.png"
    ...
    facade_parameterization={
        "0":{'window':xywh_window,
            'glass':xywh_glass,
            'windowDepth':0.2,
            'glassDepth':0.1,
            },
        "1":{'window':xywh_window,
            'glass':xywh_glass,
            'windowDepth':0.2,
            'glassDepth':0.1,
            },
    ...
    obj = bpy.context.scene.objects.get("Cube.001")  
