...
def ajust_UV(bm_uv_layer,face,polygonPlane):
...
def main():
    ...
    xyxy_glass=np.array([
        ...
        [27+86*1, 66,  74+86*1, 80],
        [27+86*1, 85,  47+86*1, 99],
        [55+86*1, 85,  74+86*1, 99],
        [27+86*1, 101, 47+86*1, 114],
        [55+86*1, 101, 74+86*1, 114],
        [27+86*1, 117, 47+86*1, 130],
        [55+86*1, 117, 74+86*1, 130],
        [27+86*1, 135, 74+86*1, 148],

        [27+86*2, 66,  74+86*2, 80],
        [27+86*2, 85,  47+86*2, 99],
        [55+86*2, 85,  74+86*2, 99],
        [27+86*2, 101, 47+86*2, 114],
        [55+86*2, 101, 74+86*2, 114],
        [27+86*2, 117, 47+86*2, 130],
        [55+86*2, 117, 74+86*2, 130],
        [27+86*2, 135, 74+86*2, 148],

        [27+86*3, 66,  74+86*3, 80],
        [27+86*3, 85,  47+86*3, 99],
        [55+86*3, 85,  74+86*3, 99],
        [27+86*3, 101, 47+86*3, 114],
        [55+86*3, 101, 74+86*3, 114],
        [27+86*3, 117, 47+86*3, 130],
        [55+86*3, 117, 74+86*3, 130],
        [27+86*3, 135, 74+86*3, 148],
        
        [27+86*4, 66,  74+86*4, 80],
        [27+86*4, 85,  47+86*4, 99],
        [55+86*4, 85,  74+86*4, 99],
        [27+86*4, 101, 47+86*4, 114],
        [55+86*4, 101, 74+86*4, 114],
        [27+86*4, 117, 47+86*4, 130],
        [55+86*4, 117, 74+86*4, 130],
        [27+86*4, 135, 74+86*4, 148],

        [27+86*5, 66,  74+86*5, 80],
        [27+86*5, 85,  47+86*5, 99],
        [55+86*5, 85,  74+86*5, 99],
        [27+86*5, 101, 47+86*5, 114],
        [55+86*5, 101, 74+86*5, 114],
        [27+86*5, 117, 47+86*5, 130],
        [55+86*5, 117, 74+86*5, 130],
        [27+86*5, 135, 74+86*5, 148],

        [27+86*6, 66,  74+86*6, 80],
        [27+86*6, 85,  47+86*6, 99],
        [55+86*6, 85,  74+86*6, 99],
        [27+86*6, 101, 47+86*6, 114],
        [55+86*6, 101, 74+86*6, 114],
        [27+86*6, 117, 47+86*6, 130],
        [55+86*6, 117, 74+86*6, 130],
        [27+86*6, 135, 74+86*6, 148],
        
       
        [27,  66+163,  74, 80+163],
        [27,  85+163,  47, 99+163],
        [55,  85+163,  74, 99+163],
        [27, 101+163, 47, 114+163],
        [55, 101+163, 74, 114+163],
        [27, 117+163, 47, 130+163],
        [55, 117+163, 74, 130+163],
        [27, 135+163, 74, 148+163],

        [27+86*1,  66+163,  74+86*1, 80+163],
        [27+86*1,  85+163,  47+86*1, 99+163],
        [55+86*1,  85+163,  74+86*1, 99+163],
        [27+86*1, 101+163, 47+86*1, 114+163],
        [55+86*1, 101+163, 74+86*1, 114+163],
        [27+86*1, 117+163, 47+86*1, 130+163],
        [55+86*1, 117+163, 74+86*1, 130+163],
        [27+86*1, 135+163, 74+86*1, 148+163],

        [27+86*2,  66+163,  74+86*2, 80+163],
        [27+86*2,  85+163,  47+86*2, 99+163],
        [55+86*2,  85+163,  74+86*2, 99+163],
        [27+86*2, 101+163, 47+86*2, 114+163],
        [55+86*2, 101+163, 74+86*2, 114+163],
        [27+86*2, 117+163, 47+86*2, 130+163],
        [55+86*2, 117+163, 74+86*2, 130+163],
        [27+86*2, 135+163, 74+86*2, 148+163],

        [27+86*3,  66+163,  74+86*3, 80+163],
        [27+86*3,  85+163,  47+86*3, 99+163],
        [55+86*3,  85+163,  74+86*3, 99+163],
        [27+86*3, 101+163, 47+86*3, 114+163],
        [55+86*3, 101+163, 74+86*3, 114+163],
        [27+86*3, 117+163, 47+86*3, 130+163],
        [55+86*3, 117+163, 74+86*3, 130+163],
        [27+86*3, 135+163, 74+86*3, 148+163],
        
        [27+86*4,  66+163,  74+86*4, 80+163],
        [27+86*4,  85+163,  47+86*4, 99+163],
        [55+86*4,  85+163,  74+86*4, 99+163],
        [27+86*4, 101+163, 47+86*4, 114+163],
        [55+86*4, 101+163, 74+86*4, 114+163],
        [27+86*4, 117+163, 47+86*4, 130+163],
        [55+86*4, 117+163, 74+86*4, 130+163],
        [27+86*4, 135+163, 74+86*4, 148+163],

        [27+86*5,  66+163,  74+86*5, 80+163],
        [27+86*5,  85+163,  47+86*5, 99+163],
        [55+86*5,  85+163,  74+86*5, 99+163],
        [27+86*5, 101+163, 47+86*5, 114+163],
        [55+86*5, 101+163, 74+86*5, 114+163],
        [27+86*5, 117+163, 47+86*5, 130+163],
        [55+86*5, 117+163, 74+86*5, 130+163],
        [27+86*5, 135+163, 74+86*5, 148+163],

        [27+86*6,  66+163,  74+86*6, 80+163],
        [27+86*6,  85+163,  47+86*6, 99+163],
        [55+86*6,  85+163,  74+86*6, 99+163],
        [27+86*6, 101+163, 47+86*6, 114+163],
        [55+86*6, 101+163, 74+86*6, 114+163],
        [27+86*6, 117+163, 47+86*6, 130+163],
        [55+86*6, 117+163, 74+86*6, 130+163],
        [27+86*6, 135+163, 74+86*6, 148+163],    
                ])
    xywh_window= xyxy_to_xywh(xyxy_window)
    xywh_glass= xyxy_to_xywh(xyxy_glass)
    image_path = r"E:\Desktop\facade\00144_.jpg"
